...
from pyage.workflows.plotting_runtime import PlotSession
...
def _run_simplex(context: WorkflowContext) -> tuple[str, LpmDist]:
    method = Simplex(
        FORWARD_UNCERTAINTY,
...
def _run_metropolis_hastings(context: WorkflowContext) -> tuple[str, LpmDist]:
...
def _run_calibrations(context: WorkflowContext) -> dict[str, LpmDist]:
    results: dict[str, LpmDist] = {}
