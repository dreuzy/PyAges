...
CONFIG_PATH = REPO_ROOT / "examples" / "natural" / "albuquerque" / "exemple_albuquerque_shapefree.yaml"
...
def test_albuquerque_shapefree_config_uses_local_lpm_directory():
    ...
    assert params.directory_lpm == REPO_ROOT / "examples" / "natural" / "albuquerque" / "data_lpm"
