...
| `data_core/data_tracer/3H/recharge.csv` | Tritium precipitation history attributed in the file header to the IAEA/WMO Global Network of Isotopes in Precipitation (GNIP), <https://nucleus.iaea.org/wiser>. | Cite the IAEA GNIP database. Users reusing the data outside PyAge must check the current IAEA data-use terms. |
