...
|---|---|---|
| Standard selection | 824 | 82 |
| Extensive opt-in | 5 | 2 |
| Core including extensive | 829 | 82 |
| TracerLPM validation | 65 | 9 |
| All documented pytest scopes | 894 | 91 |

## Cases by area

| Area | Location | Primary type | Contract | CI scope | Modules | Cases |
|---|---|---|---|---|---|---|
| Repository-wide contracts | `tests/(root)/` | Contract / integration | Public API, metadata, manifests, paths, and repository documentation | Standard CI | 9 | 27 |
| Calibration and inference | `tests/calibration/` | Unit / scientific | Objectives, priors, proposals, parameter grids, and calibration APIs | Standard CI; selected extensive cases | 12 | 68 |
| Command-line interface | `tests/cli/` | Contract / integration | Installed command behavior, validation, discovery, and user-facing errors | Standard CI and package smoke test | 2 | 19 |
| Concentration handling | `tests/concentrations/` | Unit / data contract | Chronicle loading and concentration-series behavior | Standard CI | 2 | 19 |
| Configuration | `tests/config/` | Unit / contract | Validated models, runtime options, and portable path resolution | Standard CI | 2 | 29 |
...
| Input/output | `tests/io/` | Unit / data contract | LPM parameter parsing and serialization | Standard CI | 2 | 46 |
| Lumped-parameter models | `tests/lpm/` | Analytical / unit / golden | Distributions, moments, mixtures, registries, parameters, and generated values | Standard CI | 13 | 231 |
...
| Scientific orchestration | `tests/scripts/` | Integration / reproducibility | Article campaigns, qualification scripts, and reproducible execution support | Standard CI | 12 | 58 |
...
| Installed workflows | `tests/workflows/` | Integration / contract | Plotting runtime and single-date workflow behavior | Standard CI and package smoke test | 2 | 3 |
...
| `tests/concentrations/test_concentration_contracts.py` | Unit / data contract | Concentration contracts within concentration handling. | 18 | 0 |
| `tests/config/test_config_models.py` | Unit / contract | Config models within configuration. | 27 | 0 |
...
| `tests/io/test_lpm_params.py` | Unit / data contract | LPM params within input/output. | 43 | 0 |
| `tests/io/test_lpm_results.py` | Unit / data contract | LPM results within input/output. | 3 | 0 |
...
| `tests/lpm/test_lpm_sample_table.py` | Analytical / unit / golden | LPM sample table within lumped-parameter models. | 13 | 0 |
...
| `tests/scripts/test_article_campaign.py` | Integration / reproducibility | Article campaign within scientific orchestration. | 11 | 0 |
| `tests/scripts/test_article_support.py` | Integration / reproducibility | Article support within scientific orchestration. | 13 | 0 |
...
| `tests/scripts/test_zenodo_bundle.py` | Integration / reproducibility | Zenodo bundle within scientific orchestration. | 3 | 0 |
...
| `tests/test_documentation_contracts.py` | Contract / integration | Documentation contracts within repository-wide contracts. | 7 | 0 |
