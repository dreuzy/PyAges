...
class CalibrationSyntheticTest:
    ...
    def __init__(self,calib_strategy=None,ncase=10,error=0.0,
    ...
    def perform_one_case(self,i,lpm_random=True,lpm_target=None):
        ...
        ct.display_concentration_chronicles(cdata,lpm_results,str(i),self.__display_options)
        # Results storage
    ...
    def perform_ncase(self):
        ...
        for i in range(self.__ncase):
            [_,lpm_calibration,_,_] = self.perform_one_case(i)
