...
def squared_normalized_residuals(data, model, error):
    ...
    used by :class:`~pyages.calibration.problem.CalibrationProblem`.
...
__all__ = ["normalized_residual_norm", "squared_normalized_residuals"]
