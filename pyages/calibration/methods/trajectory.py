...
class MHTrajectory:
    ...
    def __init__(self, params: Iterable[str], nstep: int) -> None:
        """Preallocate trajectory columns for parameters and diagnostics."""
...
class MHStep:
    ...
    def __init__(self, source: str, fraction: float) -> None:
        """Store the proposal-step source and optional bounds fraction."""
        self.source = source
    ...
    def _load_configured_values(self, lpm: Any) -> None:
        ...
        values = lpm_params.get_steps(schema)
        if not values:
