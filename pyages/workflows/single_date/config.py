...
# and validates it with the workflow schema. It returns resolved data, model,
...
def load_config_payload(root_dir: Path, data: dict) -> SingleDateConfig:
...
def load_config(root_dir: Path, params_path: Path) -> SingleDateConfig:
